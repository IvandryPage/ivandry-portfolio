            ...
            <div className="flex flex-col justify-between gap-8">
              <div className="flex flex-wrap gap-4">
                <Link href={"#"} className="group relative px-6 py-2.5 rounded-full border border-brand/40 overflow-hidden flex items-center gap-3">
                   ...
                   <span className="relative z-10 text-[10px] uppercase tracking-widest font-bold group-hover:text-background transition-colors">Launch Demo</span>
                </Link>
                
                <Link href={"#"} className="px-4 py-2.5 text-[10px] uppercase tracking-widest text-foreground-muted hover:text-white transition-colors">
                  Source
                </Link>
              </div>
